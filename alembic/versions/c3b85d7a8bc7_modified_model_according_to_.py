...
def upgrade():
    ...
    op.create_table('operation_type_xref_service',
                    ...
                    sa.ForeignKeyConstraint(
                        ['service_id'], ['service.id'], ondelete='SET NULL'),
    ...
    op.drop_constraint('operation_type_original_id_key',
                       'operation_type', type_='unique')
    op.drop_column('operation_type', 'original_id')
    op.drop_constraint('realty_details_original_id_key',
                       'realty_details', type_='unique')
    op.drop_column('realty_details', 'original_id')
    op.drop_constraint('realty_type_original_id_key',
                       'realty_type', type_='unique')
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('state', sa.Column('original_id', sa.BIGINT(),
                                     autoincrement=False, nullable=False))
    op.create_unique_constraint(
        'state_original_id_key', 'state', ['original_id'])
    op.add_column('realty_type', sa.Column(
        'original_id', sa.BIGINT(), autoincrement=False, nullable=False))
    op.create_unique_constraint(
        'realty_type_original_id_key', 'realty_type', ['original_id'])
    op.add_column('realty_details', sa.Column(
        'original_id', sa.BIGINT(), autoincrement=False, nullable=False))
    op.create_unique_constraint(
        'realty_details_original_id_key', 'realty_details', ['original_id'])
    op.add_column('operation_type', sa.Column(
        'original_id', sa.BIGINT(), autoincrement=False, nullable=False))
    op.create_unique_constraint(
        'operation_type_original_id_key', 'operation_type', ['original_id'])
    op.add_column('city', sa.Column('original_id', sa.BIGINT(),
                                    autoincrement=False, nullable=False))
    op.create_unique_constraint(
