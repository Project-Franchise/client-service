...
def upgrade():
    ...
    op.create_foreign_key(None, 'city_to_service', 'city', ['city_id', 'version'], ['self_id', 'version'], ondelete='CASCADE')
    ...
    op.create_foreign_key(None, 'operation_type_to_service', 'operation_type', ['operation_type_id', 'version'], ['self_id', 'version'], ondelete='CASCADE')
    ...
    op.create_foreign_key(None, 'realty_type_to_service', 'realty_type', ['realty_type_id', 'version'], ['self_id', 'version'], ondelete='CASCADE')
    ...
    op.create_foreign_key(None, 'state_to_service', 'state', ['state_id', 'version'], ['self_id', 'version'], ondelete='CASCADE')
...
def downgrade():
    ...
    op.create_foreign_key('state_to_service_state_id_version_fkey', 'state_to_service', 'state', ['state_id', 'version'], ['self_id', 'version'], ondelete='RESTRICT')
    ...
    op.create_foreign_key('realty_type_to_service_realty_type_id_version_fkey', 'realty_type_to_service', 'realty_type', ['realty_type_id', 'version'], ['self_id', 'version'], ondelete='RESTRICT')
    ...
    op.create_foreign_key('operation_type_to_service_operation_type_id_version_fkey', 'operation_type_to_service', 'operation_type', ['operation_type_id', 'version'], ['self_id', 'version'], ondelete='RESTRICT')
    ...
    op.create_foreign_key('city_to_service_city_id_version_fkey', 'city_to_service', 'city', ['city_id', 'version'], ['self_id', 'version'], ondelete='RESTRICT')
