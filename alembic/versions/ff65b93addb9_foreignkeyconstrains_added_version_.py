...
def upgrade():
    ...
    op.add_column('state_to_service', sa.Column('version', sa.TIMESTAMP(), nullable=False))
    op.drop_constraint('state_to_service_service_id_fkey', 'state_to_service', type_='foreignkey')
    op.drop_constraint('state_to_service_state_id_fkey', 'state_to_service', type_='foreignkey')
    op.create_foreign_key(None, 'state_to_service', 'state', ['state_id', 'version'], ['self_id', 'version'], ondelete='RESTRICT')
    op.create_foreign_key(None, 'state_to_service', 'service', ['service_id'], ['id'], ondelete='CASCADE')
    ...
    op.add_column('city_to_service', sa.Column('version', sa.TIMESTAMP(), nullable=False))
    op.drop_constraint('city_to_service_city_id_fkey', 'city_to_service', type_='foreignkey')
    op.drop_constraint('city_to_service_service_id_fkey', 'city_to_service', type_='foreignkey')
    op.create_foreign_key(None, 'city_to_service', 'service', ['service_id'], ['id'], ondelete='CASCADE')
    op.create_foreign_key(None, 'city_to_service', 'city', ['city_id', 'version'], ['self_id', 'version'], ondelete='RESTRICT')
    ...
    op.add_column('operation_type_to_service', sa.Column('version', sa.TIMESTAMP(), nullable=False))
    op.drop_constraint('operation_type_to_service_operation_type_id_fkey', 'operation_type_to_service', type_='foreignkey')
    op.drop_constraint('operation_type_to_service_service_id_fkey', 'operation_type_to_service', type_='foreignkey')
    op.create_foreign_key(None, 'operation_type_to_service', 'operation_type', ['operation_type_id', 'version'], ['self_id', 'version'], ondelete='RESTRICT')
    op.create_foreign_key(None, 'operation_type_to_service', 'service', ['service_id'], ['id'], ondelete='CASCADE')
    ...
    op.add_column('realty_type_to_service', sa.Column('version', sa.TIMESTAMP(), nullable=False))
    op.drop_constraint('realty_type_to_service_service_id_fkey', 'realty_type_to_service', type_='foreignkey')
    op.drop_constraint('realty_type_to_service_realty_type_id_fkey', 'realty_type_to_service', type_='foreignkey')
    op.create_foreign_key(None, 'realty_type_to_service', 'realty_type', ['realty_type_id', 'version'], ['self_id', 'version'], ondelete='RESTRICT')
    op.create_foreign_key(None, 'realty_type_to_service', 'service', ['service_id'], ['id'], ondelete='CASCADE')
...
def downgrade():
    ...
    op.drop_constraint(None, 'state_to_service', type_='foreignkey')
    op.create_foreign_key('state_to_service_state_id_fkey', 'state_to_service', 'state', ['state_id'], ['id'], ondelete='SET NULL')
    op.create_foreign_key('state_to_service_service_id_fkey', 'state_to_service', 'service', ['service_id'], ['id'], ondelete='SET NULL')
    ...
    op.drop_constraint(None, 'realty_type_to_service', type_='foreignkey')
    op.create_foreign_key('realty_type_to_service_realty_type_id_fkey', 'realty_type_to_service', 'realty_type', ['realty_type_id'], ['id'], ondelete='SET NULL')
    op.create_foreign_key('realty_type_to_service_service_id_fkey', 'realty_type_to_service', 'service', ['service_id'], ['id'], ondelete='SET NULL')
    ...
    op.drop_constraint(None, 'operation_type_to_service', type_='foreignkey')
    op.create_foreign_key('operation_type_to_service_service_id_fkey', 'operation_type_to_service', 'service', ['service_id'], ['id'], ondelete='SET NULL')
    op.create_foreign_key('operation_type_to_service_operation_type_id_fkey', 'operation_type_to_service', 'operation_type', ['operation_type_id'], ['id'], ondelete='SET NULL')
    ...
    op.drop_constraint(None, 'city_to_service', type_='foreignkey')
    op.create_foreign_key('city_to_service_service_id_fkey', 'city_to_service', 'service', ['service_id'], ['id'], ondelete='SET NULL')
    op.create_foreign_key('city_to_service_city_id_fkey', 'city_to_service', 'city', ['city_id'], ['id'], ondelete='SET NULL')
