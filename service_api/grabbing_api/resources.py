...
class RequestToDomria(Resource):
    """Send requests for getting list of id of items"""

    @staticmethod
    def form_new_dict(params) -> dict:
        """
    ...
    def get(self):
        ...
        #amount_of_items = items_json.get("count")
        #items_from_domria = [items for items in items_json["items"]]
        return items_json
...
api_.add_resource(RequestToDomria, "/get/search")